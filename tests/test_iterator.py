...
class DateIteratorTest(unittest.TestCase):
    ...
    def test_should_skip_weekends(self):
        ...
        self.assertEqual(postponned, [Postpone(date, "weekend", True)])
    ...
    def test_should_skip_holidays(self):
        ...
        self.assertEqual(postponned, [Postpone(date, "holiday", True)])
    ...
    def test_next(self):
        ...
        self.assertEqual(next(iterator), (datetime.date(2024, 1, 2), False, [Postpone(datetime.date(2024, 1, 1), "holiday", True)]))
        ...
        self.assertEqual(next(iterator), (datetime.date(2024, 1, 8), False, [Postpone(datetime.date(2024, 1, 7), "weekend", True)]))
